...
// 고객 상세정보 저장
const saveCustomerD = () => {
  // 고객 목록에서 현재 선택된 인덱스를 찾는다(-1 말도 안되는 임의의 숫자를 넣어서 찾는다)
